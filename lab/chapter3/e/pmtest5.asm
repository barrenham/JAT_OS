...
LABEL_DESC_CODE_RING3: Descriptor 0, SegCodeRing3Len-1, DA_C+DA_32+DA_DPL3    ;<-------------------这个是A
...
LABEL_DESC_CODE_B:	   Descriptor 0,			0ffffh, DA_CCO+DA_32+DA_DPL0
LABEL_DESC_CODE_C:	   Descriptor 0,			0ffffh, DA_C+DA_32+DA_DPL3

; 门                                            目标选择子,       偏移, DCount, 属性
LABEL_CALL_GATE_TEST:	Gate		  SelectorCodeB,          0,      0, DA_386CGate + DA_DPL3
; GDT 结束
...
SelectorCodeB		equ LABEL_DESC_CODE_B   - LABEL_GDT
SelectorCodeC		equ LABEL_DESC_CODE_C	- LABEL_GDT
...
LABEL_BEGIN:
	...
	mov	word [LABEL_DESC_CODE_C + 2], ax
	shr	eax, 16
	mov	byte [LABEL_DESC_CODE_C + 4], al
	mov	byte [LABEL_DESC_CODE_C + 7], ah
